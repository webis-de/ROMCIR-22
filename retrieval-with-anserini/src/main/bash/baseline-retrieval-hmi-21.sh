...
TOPICS="${REPO}/third-party/health-misinfo-21/topics.xml"
INDEX="/home/webis/indexes/lucene-index.c4noclean"
OUT_PREFIX="/mnt/ceph/storage/data-in-progress/data-research/web-search/romcir22-keyquery/runs/hmi-21/run.hmi21"
