...
TOPICS="${REPO}/third-party/health-misinfo-20/topics.xml"
INDEX="/home/webis/lucene-index.cc-news-20"
OUT_PREFIX="/mnt/ceph/storage/data-in-progress/data-research/web-search/romcir22-keyquery/runs/hmi-20/run.hmi20"
